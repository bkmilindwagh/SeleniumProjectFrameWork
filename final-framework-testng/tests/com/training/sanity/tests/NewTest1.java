...
private WebDriver driver;
	...
	@Test
	public void AdminAddProduct1() throws InterruptedException {
		...
		prodGenPOM.sendinputname("test");
		categoryPOM.sendCategDescription("test");
		
		// JavascriptExecutor js = (JavascriptExecutor) driver;
		 //js.executeScript("window.scrollBy(0,1000)");
		 
		categoryPOM.sendMetaTagtitle("test");
		categoryPOM.sendMetaTagdescription("test");
